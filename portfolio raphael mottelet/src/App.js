...
import { Experience, Projects, Personal_Projects, Promeo_Projects, SocialLinks } from "./data";
    ...
    <AnimatePresence initial={false}>
      <div className="flex w-screen min-h-screen flex-col items-center justify-center relative bg-primary pb-20">
        <nav className="w-full px-6 z-50  fixed inset-x-0 top-2 flex justify-center items-center ">
          <div className=" w-full md:w-1000 bg-navBar p-4 rounded-2xl flex items-center">
            <p className="text-lg text-slate-200 font-medium">Portfolio Raphaël Mottelet</p>
        ...
        <div className="relative" id="home">
          ...
          <div className="absolute bottom-10 w-full flex justify-center items-center">
            <div className="shadow-md p-4 flex items-center justify-center bg-zinc-900 rounded-3xl ">
              <p className="text-white">Utilisez votre curseur !</p>
            </div>
          </div>
        </div>
...
<div className="spacing1"></div>
          ...
          <div className="shadow-md p-4 flex items-center justify-center bg-zinc-900 rounded-3xl ">
              <p className="text-white">Mes projets en entreprise</p>
            </div>
                  ...
                  <div className="flex flex-1 items-center justify-between">
                    ...
                    <a href={n.github}>
                      <motion.div whileTap={{ scale: 0.5 }}>
                        <IoLogInOutline className="text-textBase text-3xl cursor-pointer" />
                      </motion.div>
                    </a>
                  </div>
                </motion.div>
...
<div className="shadow-md p-4 flex items-center justify-center bg-zinc-900 rounded-3xl ">
    <p className="text-white">Mes projets à Promeo</p>
  </div>          
          <section
            className="flex flex-wrap items-center justify-evenly my-24 gap-4"
            id="Promeo_Projects"
...
<div className="spacing1"></div>
          ...
          <div className="shadow-md p-4 flex items-center justify-center bg-zinc-900 rounded-3xl ">
              <p className="text-white">Mes projets Personnels</p>
            </div>
...
<div className="shadow-md p-4 flex items-center justify-center bg-zinc-900 rounded-3xl ">
    <p className="text-white">Me contacter</p>
  </div>
